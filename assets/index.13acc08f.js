import{L as y}from"./index.b0bc66d4.js";import{ag as f}from"./vendor.01b03999.js";/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
 */class g{constructor(e){const n=this._textarea=document.createElement("textarea"),t=n.style;t.opacity="0",t.position="absolute",t.left=t.top="-999em",n.setAttribute("aria-hidden","true"),n.value=e,document.body.appendChild(n)}copy(){const e=this._textarea;let n=!1;try{if(e){const t=document.activeElement;e.select(),e.setSelectionRange(0,e.value.length),n=document.execCommand("copy"),t&&t.focus()}}catch(t){y.error("cdk/clipboard",t)}return n}destroy(){const e=this._textarea;e&&(e.parentNode&&e.parentNode.removeChild(e),this._textarea=void 0)}}/**
 * @license
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/IDuxFE/idux/blob/main/LICENSE
